...
- [[2026-07-24-sequential-batch-upload/proposal|sequential-batch-upload]] — Multi-file selection and sequential processing
- [[2026-07-23-shared-finance-store/proposal|shared-finance-store]] — Earlier iteration: shared store + dedicated AI config store

## Specifications

- [[ai-config-store/spec|ai-config-store]] — Persistent LM Studio configuration with one-time migration
