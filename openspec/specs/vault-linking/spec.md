...
---
# Specification: Vault Linking

## Purpose

Define how OpenSpec content in the Obsidian vault must be connected as a navigable graph, so that any artifact can be reached from any other through wikilinks, tags, bookmarks, or the central MOC.
...
- [[../changes/archive/2026-07-24-openspec-vault-link/proposal|2026-07-24]] — Initial capability: wikilinks between artifacts, source-file linking in tasks, History sections on canonical specs, single MOC, frontmatter tags, workspace.json bookmarks, idempotent operation, auto-trigger integration, context folder convention
